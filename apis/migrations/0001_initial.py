    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_foods', models.ManyToManyField(to='apis.specialfood')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apis.student')),
                ('given_by', models.ForeignKey(blank=True, limit_choices_to={'role': 'kitchen_staff'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='kitchen_given', to='apis.user')),
                ('issued_by', models.ForeignKey(limit_choices_to={'role': 'clinic_staff'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='clinic_issued', to='apis.user')),
            ],
        ),
    ]
