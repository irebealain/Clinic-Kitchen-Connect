...
const UserList = () => {
    ...
    return (
        ...
        <hr className='border-[#d1d1d1]'/>
            <h2 className="text-xl sm:text-2xl font-bold text-green-600 mb-4 pl-8 sm:pl-16 mt-8">Clinic Staff</h2>
            <div className="overflow-x-auto ml-8 sm:ml-16">
            <table className="w-full sm:w-[90%] border border-gray-200">
